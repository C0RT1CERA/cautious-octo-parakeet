...
import RevealLinks from '@/components/framercomp/RevealLinks';
const Home = () => {
  return (
    <div className='z-25 min-h-screen pt-[135px]'> {/* Adjust pt-[135px] based on your navbar height */}
      <div className='flex flex-col md:flex-row items-start justify-center h-full'>
        ...
        <div className="relative hidden md:block w-full md:w-1/2 bg-zinc-50 border-r-4 border-b-4 border-stone-800 h-[3667px]">
