const Cards1 = () => {
    const cards = [
        {
            heading: "Accounts Receivable (AR) Management",
            description: "Efficient handling of outstanding patient balances and insurance claims",
            image: "https://images.pexels.com/photos/60597/dahlia-red-blossom-bloom-60597.jpeg"
        },
        {
            heading: "Denial Management",
            description: "Investigation and appeal of claim denials to maximize reimbursements.",
            image: "https://images.pexels.com/photos/60597/dahlia-red-blossom-bloom-60597.jpeg"
        },
        {
            heading: "Patient Statement Management:",
            description: "Generation and distribution of statements for patient payments.",
            image: "https://images.pexels.com/photos/60597/dahlia-red-blossom-bloom-60597.jpeg"
        }
    ];
